...
import 'package:triftly/features/3_routine_builder/bloc/routine_builder_bloc.dart';
...
import 'package:triftly/features/3_routine_builder/presentation/widgets/bottom_sheets/routine_day_edit_day_metadata_bottom_sheet.dart';
...
class _DaySpotsMoreButton extends StatelessWidget {
  ...
  Future<void> _showMenu(BuildContext context) async {
    ...
    if (result == 'delete') {
      await _confirmDeleteAllSpots(context,
          dayIndex: dayIndex, spotCount: spotCount);
    }
  }
