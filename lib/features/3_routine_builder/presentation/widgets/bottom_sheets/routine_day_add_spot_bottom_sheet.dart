...
class _RoutineDayAddSpotBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      padding:
          EdgeInsets.fromLTRB(24, 20, 24, 24 + bottomPadding + keyboardHeight),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration:
                          _inputDecoration(context, 'Address or place name'),
                      textCapitalization: TextCapitalization.words,
                    ),
                  ),
  ...
  Widget _buildTimePickerField(
    ...
    return Material(
      ...
      child: InkWell(
        onTap: () =>
            _pickTime(context, controller: controller, initial: initial),
...
class _TimePickerSheetState extends State<_TimePickerSheet> {
  ...
  int get _hourIndex =>
      _indexFromOffset(_hourController, 12, _initialHourIndex);
  int get _minuteIndex =>
      _indexFromOffset(_minuteController, 60, _initialMinuteIndex);
  ...
  TimeOfDay get _currentTime {
    ...
    final hour24 =
        hour12 == 12 ? (isAm ? 0 : 12) : (isAm ? hour12 : hour12 + 12);
  ...
  void initState() {
    ...
    _hourController =
        FixedExtentScrollController(initialItem: _initialHourIndex);
    _minuteController =
        FixedExtentScrollController(initialItem: _initialMinuteIndex);
    _ampmController =
        FixedExtentScrollController(initialItem: _initialAmpmIndex);
