...
| Term | Where / meaning |
|------|------------------|
| **MapLocation** | Model in `lib/features/4_map_view/models/map_location.dart`. Holds id, title, address, position, plus optional placeId, rating, types, openingHoursText, photoUrl, website, phoneNumber, locality. |
