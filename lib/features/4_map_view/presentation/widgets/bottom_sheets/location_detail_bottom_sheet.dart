...
class LocationDetailBottomSheet extends StatelessWidget {
  ...
  static Future<void> showWithFuture(BuildContext context,
      {required Future<MapLocation> locationFuture}) {
    return showAppModalBottomSheet<void>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => LocationDetailBottomSheet(
          location: null, locationFuture: locationFuture),
    );
  }
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            if (loc.rating != null ||
                (loc.types != null && loc.types!.isNotEmpty)) ...[
...
class _ActionRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final hasCoords =
        location.position.latitude != 0 || location.position.longitude != 0;
      ...
      child: Row(
        children: [
          ...
          if (location.phoneNumber != null && location.phoneNumber!.isNotEmpty)
            OutlinedButton.icon(
              onPressed: () => LocationDetailBottomSheet._openUrl(
          ...
          OutlinedButton.icon(
            onPressed: () =>
                LocationDetailBottomSheet._onAddToRoutine(context, location),
            ...
            child: GestureDetector(
              ...
              child: Text(
                ...
                style: theme.textTheme.bodyMedium?.copyWith(
                  ...
                  decoration:
                      accent && onTap != null ? TextDecoration.underline : null,
                ),
              ),
            ),
          ),
...
class _LocationDetailSheetWithFuture extends StatefulWidget {
  ...
  @override
  State<_LocationDetailSheetWithFuture> createState() =>
      _LocationDetailSheetWithFutureState();
}

class _LocationDetailSheetWithFutureState
    extends State<_LocationDetailSheetWithFuture> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
      ...
      FutureBuilder<MapLocation>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done &&
              snapshot.hasData) {
            return LocationDetailBottomSheet._buildContent(
